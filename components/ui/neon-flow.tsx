...
export function TubesBackground({
  ...
  useEffect(() => {
    ...
    const initTubes = async () => {
      ...
      try {
        // @ts-ignore — CDN URL, no type declarations available
    ...
    // Only run the heavy 3D effect when the Hero is actually visible
  ...
  return (
    <div
      className={cn("relative w-full h-full min-h-[400px] overflow-hidden bg-black transform-gpu translate-z-0", className)}
      onClick={handleClick}
    >
      <canvas
        ref={canvasRef}
